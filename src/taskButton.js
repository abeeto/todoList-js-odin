...
let taskButton = ElementsHelper.createGenericElement({
    ...
    classList: [ "create-task__text-style", "create-task__button-sizing", "dashed-border", "primary-bg", "flex", "flex-row-y-center", "flex-center", "min-height-task"],
    clickEventCallBack: function() {
        console.log("CLICKED!");
        const newElement = ElementsHelper.wrapElements({wrapperTag: "div", wrapperClassList: ["create-task"], elementsToWrap: [formNode, backButton]})
